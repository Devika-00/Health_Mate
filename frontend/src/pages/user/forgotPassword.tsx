  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover" >
      <div className="w-96 p-8 bg-gray-200 rounded-lg shadow-lg">
        <h2 className="font-extrabold text-blue-900 text-3xl mb-2">Forgot Password</h2>
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <button type="submit" className="bg-blue-900 hover:bg-blue-800 text-white font-bold py-2 px-6 rounded-lg focus:outline-none focus:shadow-outline mt-5 mb-5">Reset Password</button>
